...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-white pt-16 md:pt-24 overflow-hidden w-full">
      <div className="w-full md:w-[80vw] mx-auto px-6 md:px-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-16 md:mb-24">
          ...
          <div className="w-full lg:max-w-[400px] flex flex-col">
            ...
            <div className="hidden lg:flex flex-row gap-3 w-fit">
              <button className="bg-[#C2F865] text-[#1a1a1a] px-6 py-3.5 rounded-lg font-semibold flex items-center justify-center gap-3 hover:scale-105 transition-all shadow-lg whitespace-nowrap min-w-max">
                 <Image 
              ...
              <button className="flex items-center justify-center bg-[#2F401A] text-white px-6 py-3.5 rounded-lg font-semibold text-[13px] md:text-sm hover:bg-[#3d5225] transition-colors whitespace-nowrap min-w-max">
          ...
          <div className="flex flex-col w-full lg:w-auto">
            ...
            <div className="flex flex-col gap-3 md:gap-4">
              <a href="#" className="text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">About</a>
              <a href="#" className="text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">Partners</a>
              <a href="#" className="text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">Contact</a>
              <a href="#" className="text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">Privacy Policy</a>
              <a href="#" className="text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">Terms</a>
            </div>
          </div>
          ...
          <div className="flex flex-col w-full lg:max-w-[300px]">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                <a href="tel:+97140000000" className="flex items-center gap-2 text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">
                  <Phone className="w-4 h-4 text-[#1a1a1a]/60" />
                  +971 4 000 0000
                </a>
                <a href="mailto:hello@scooterit.com" className="flex items-center gap-2 text-[#1a1a1a]/80 hover:text-[#2F401A] transition-colors text-sm md:text-base font-semibold">
          ...
          <div className="flex lg:hidden flex-col gap-4 w-full mt-2">
            <button className="w-full flex items-center justify-center gap-2 bg-[#C2F865] text-[#1a1a1a] px-6 py-4 rounded-xl font-semibold text-[15px] hover:bg-[#b5eb5a] transition-colors">
            ...
            <button className="w-full flex items-center justify-center bg-[#2F401A] text-white px-6 py-4 rounded-xl font-semibold text-[15px] hover:bg-[#3d5225] transition-colors">
              Become a Fleet Partner
            </button>
          </div>
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-black/20 mb-6 md:mb-8"></div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12 md:mb-16">
          ...
          <div className="flex gap-4 md:gap-6 items-center">
            {/* Instagram */}
            <a href="#" className="text-[#1a1a1a] hover:text-[#2F401A] transition-colors">
            ...
            {/* X (Twitter) */}
            <a href="#" className="text-[#1a1a1a] hover:text-[#2F401A] transition-colors font-semibold text-lg leading-none">
      ...
      <div className="w-full relative h-[180px] md:h-[300px]">
         {/* Background Layer */}
         <Image 
