...
const StepCard = ({ step }: { step: any }) => (
  <div className="w-[33vh] h-[38vh] rounded-2xl flex flex-col relative shrink-0">
    {/* Step Badge Overlap */}
    ...
    <div className="relative w-full h-1/2 bg-white pl-0.5 pr-0.5 pt-0.5 rounded-t-2xl">
      <div className="relative bg-black w-full h-full rounded-t-2xl">
        ...
        <div className="absolute bottom-0 w-full h-[27vh] z-30">
          {/* Main Phone Image */}
          <div className="absolute bottom-0 w-full h-[90%] z-10">
            <Image 
              src={step.mainImg} 
              alt={step.stepLabel} 
              fill 
  ...
  return (
    <section className="relative z-10 bg-black py-24 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto">
        {/* Header */}
        <div className="text-center mb-16 lg:mb-28 text-white">
